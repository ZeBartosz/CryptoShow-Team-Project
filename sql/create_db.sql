...
DROP
    DATABASE IF EXISTS cryptoshow_db;
CREATE DATABASE cryptoshow_db; USE
    cryptoshow_db;
CREATE USER IF NOT EXISTS cryptoshowuser @localhost IDENTIFIED BY 'cryptoshowpass'; GRANT
SELECT
    ,
INSERT
    ,
    ...
    DELETE
ON
    cryptoshow_db.* TO cryptoshowuser @localhost;
    -- -------------------------------------
...
-- --------------------------------
ALTER TABLE
    `registered_user` ADD COLUMN `is_admin` BOOLEAN DEFAULT FALSE;
    -- --------------------------------
